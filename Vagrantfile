...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider "virtualbox" do |v|
    ...
    config.vm.define "consul-dc1-server-0" do |consul0|
        ...
        consul0.vm.network "public_network", ip: "#{WAN_IP}.100", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc1-server-1" do |consul1|
        ...
        consul1.vm.network "public_network", ip: "#{WAN_IP}.150", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc1-server-2" do |consul2|
        ...
        consul2.vm.network "public_network", ip: "#{WAN_IP}.160", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc1-server-3" do |consul3|
        ...
        consul3.vm.network "public_network", ip: "#{WAN_IP}.165", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc1-mesh-gw" do |primary_mesh|
        ...
        primary_mesh.vm.network "public_network", ip: "#{WAN_IP}.155", bridge: "en8: AX88179A"
        primary_mesh.vm.network "forwarded_port", guest: 19000, host: 19000, protocol: "tcp", host_ip: "127.0.0.1"
    ...
    config.vm.define "consul-dc1-client-0" do |client0|
        ...
        client0.vm.network "public_network", ip: "#{WAN_IP}.200", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc1-client-1" do |client1|
        ...
        client1.vm.network "public_network", ip: "#{WAN_IP}.201", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-server-0" do |consul20|
        ...
        consul20.vm.network "public_network", ip: "#{WAN_IP}.170", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-server-1" do |consul21|
        ...
        consul21.vm.network "public_network", ip: "#{WAN_IP}.180", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-server-2" do |consul22|
        ...
        consul22.vm.network "public_network", ip: "#{WAN_IP}.190", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-server-3" do |consul23|
        ...
        consul23.vm.network "public_network", ip: "#{WAN_IP}.195", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-mesh-gw" do |secondary_mesh|
      ...
      secondary_mesh.vm.network "public_network", ip: "#{WAN_IP}.185", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-client-0" do |client20|
        ...
        client20.vm.network "public_network", ip: "#{WAN_IP}.202", bridge: "en8: AX88179A"
    ...
    config.vm.define "consul-dc2-client-1" do |client21|
        ...
        client21.vm.network "public_network", ip: "#{WAN_IP}.203", bridge: "en8: AX88179A"
